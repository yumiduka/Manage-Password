[CmdletBinding()]
param(
  [Parameter(Mandatory, ParameterSetName='List')][Alias('L')][switch]$List,
  [Parameter(Mandatory, ParameterSetName='Get')][Alias('G')][switch]$Get,
  [Parameter(Mandatory, ParameterSetName='Set')][Alias('S')][switch]$Set,
  [Parameter(Mandatory, ParameterSetName='Delete')][Alias('D')][switch]$Delete,
  [Parameter(Mandatory, ParameterSetName='Import')][Alias('I')][switch]$Import,
  [Parameter(Mandatory, ParameterSetName='Export')][Alias('E')][switch]$Export,
  [Parameter(Mandatory, ParameterSetName='Get')][Parameter(Mandatory, ParameterSetName='Set')][Parameter(Mandatory, ParameterSetName='Delete')][Alias('e','env')][string]$Environment,
  [Parameter(Mandatory, ParameterSetName='Get')][Parameter(Mandatory, ParameterSetName='Set')][Parameter(Mandatory, ParameterSetName='Delete')][Alias('a')][string]$Account,
  [Parameter(Mandatory, ParameterSetName='Set')][Alias('p')][string]$Password,
  [string]$Path = '~\.idlist',
